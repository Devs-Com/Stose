...
@Entity
@Table(name = "tb_tendencia_right")
public class TendenciaRight {
    ...
    public TendenciaRight(Long id, String img, String titulo, String autor, String id_editorial, String id_categoria,
    ...
    public TendenciaRight(String img, String titulo, String autor, String id_editorial, String id_categoria,
            String id_subcategoria, String precio_original, String precio_descuento, String porcentaje_descuento,
            String numero_pagina, String year_publicacion, String disponible) {
        this.img = img;
        this.titulo = titulo;
